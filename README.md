...
* Creating a compression-table from the schema of the object above takes about `0.007ms`
* Compressing the example-object from above takes about `0.006ms`
* Decompressing takes about `0.005ms` per object
